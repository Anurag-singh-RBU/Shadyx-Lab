  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        shadow-black/50 border border-gray-800/50 backdrop-blur-xl overflow-hidden font-mono"
        >
          {/* Tabs */}
            ...
            <div className="flex space-x-1 p-4">
              {TABS.map((tab) => (
                ...
                >
                  ...
                  <tab.icon className="w-4 h-4 relative z-10 sm:block hidden" />
                  <span className="sm:text-sm text-sm font-medium relative z-10 whitespace-nowrap">{tab.label}</span>
                </button>
              ))}
            </div>
          </div>
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4">
                          <div className="relative">
                            ...
                            <Image
                              ...
                              alt=""
                              className="rounded-lg relative z-10 object-cover sm:block hidden"
                              width={40}
                              height={40}
                            />
                          </div>
                          <div className="space-y-1">
                            <div className="flex items-center gap-2 mb-2">
                              <span className="sm:text-sm text-md font-bold text-white">
                            ...
                            <div className="flex items-center gap-2 sm:ml-0 -ml-1">
                              <span
                      ...
                      <div className="p-4 bg-black/20 rounded-b-xl border border-t-0 border-gray-800/50">
                        ...
                        {(execution.output || execution.error) && (
                          <div className="sm:mt-4 mt-12 p-4 rounded-lg bg-black/40">
                  ...
                  {isLoadingExecutions ? (
                    ...
                    executions.length === 0 && (
                      <div className="text-center py-12">
                        ...
                        <p className="text-gray-500 sm:block hidden">Start coding to see your execution history !!</p>
                      </div>
                    )
                  )}
