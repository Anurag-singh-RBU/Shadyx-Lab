  ...
  return (
    <div className="relative sm:block hidden" ref={dropdownRef}>
      <motion.button
        ...
        className="w-auto sm:text-md text-xs whitespace-nowrap py-2 px-3 rounded-md group relative flex items-center gap-2 sm:px-4 sm:py-3 bg-[#1e1e2e]/80 hover:bg-[#262637] 
        sm:rounded-lg transition-all duration-200 border border-gray-800/50 hover:border-gray-700"
      >
        ...
        <span className="text-gray-300 w-auto text-left group-hover:text-white transition-colors">
          {currentTheme?.label}
        </span>
      </motion.button>
          ...
          >
            ...
            {THEMES.map((t, index) => (
              ...
              group-hover:opacity-100 transition-opacity"
                ...
                <div
                  className={`
                sm:flex hidden items-center justify-center sm:size-8 sm:rounded-lg
