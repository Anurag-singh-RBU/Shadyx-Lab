    ...
    >
      <Link href={`/snippets/${snippet._id}`} className="h-full block">
        <div
          ...
          transition-all duration-300 overflow-hidden font-mono"
        >
          <div className="p-6">
            {/* Header */}
              ...
              <div>
                ...
                <div className="flex items-center gap-3 text-sm text-gray-400">
                  <div className="flex items-center gap-2">
                    <div className="p-1 rounded-md bg-gray-600">
                      <User className="size-3" color="white"/>
                    </div>
                    <span className="truncate w-auto">{snippet.userName}</span>
                  </div>
                </div>
              </div>
            </div>
