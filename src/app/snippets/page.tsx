      ...
      <div className="relative sm:max-w-7xl w-full sm:mx-auto px-4 py-12">
        ...
        <div className="text-center sm:max-w-4xl w-full sm:mx-auto mb-16 sm:mt-10 mt-5">
          ...
          <motion.h1
            ...
            className="text-3xl leading-11 md:text-5xl font-bold bg-gradient-to-r from-gray-100 to-gray-300 text-transparent bg-clip-text sm:mb-6 mb-3"
          >
          ...
          <motion.p
            ...
            className="sm:text-lg text-gray-400 mb-8"
          >
        ...
        {/* Filters Section */}
        <div className="relative sm:max-w-5xl mx-auto mb-12 space-y-6 sm:mt-0 -mt-5 w-full sm:px-0 px-5">
          {/* Search */}
          <div className="relative group">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 sm:py-4 py-2 bg-[#1e1e2e]/80 hover:bg-[#1e1e2e] text-white
                  rounded-xl border border-[#313244] hover:border-[#414155] transition-all duration-200
                  placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 placeholder:text-sm sm:placeholder:text-sm"
              />
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center sm:gap-4 gap-2">
            <div className="flex items-center gap-2 sm:px-4 py-2 px-2 bg-[#1e1e2e] rounded-lg ring-1 ring-gray-800">
              <Tag className="w-4 h-4 text-gray-400" />
              <span className="sm:text-sm text-xs text-gray-400">Languages :</span>
            </div>
